...
const rectangle52 = "/images/Rectangle 52.png";
const rectangle54 = "/images/Rectangle 54.png";
const rectangle55 = "/images/Rectangle 55.png";
const rectangle56 = "/images/Rectangle 56.png";
const rectangle61 = "/images/Rectangle 61.png";
    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          className="absolute inset-0 bg-linear-to-r from-black/90 to-[rgba(59,130,246,0.50)] flex items-center justify-start"
          style={{
      ...
      <motion.div
        ...
        className="w-full h-4 bg-linear-to-r from-red-500 via-blue-500 to-red-500"
      />
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div className="h-px w-8 bg-amber-400 transition-all duration-500 group-hover:w-14" />
